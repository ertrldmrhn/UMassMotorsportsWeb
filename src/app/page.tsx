...
const socialLinks: Array<{
  ...
  { label: "umassmoto", href: site.instagram, icon: <InstagramIcon />, external: true },
  { label: "Umass Motorsport", href: site.discord, icon: <DiscordIcon />, external: true },
  { label: "Campus Pulse", href: site.campusPulse, logoSrc: "/campus_pulse.png", external: true },
];
