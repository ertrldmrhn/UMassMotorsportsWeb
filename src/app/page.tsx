...
const socialLinks = [
  ...
  { label: "Campus Pulse", href: site.campusPulse, icon: <BookOpen size={22} />, external: true },
  { label: "Google Drive", href: site.googleDrive, icon: <HardDrive size={22} />, external: true },
  { label: "Email Us", href: `mailto:${site.email}`, icon: <Mail size={22} />, external: false },
];
    ...
    <div className="max-w-5xl mx-auto px-4 py-8 space-y-8">
      ...
      <div className="flex flex-wrap gap-5">
        {socialLinks.map((link) => (
          ...
          >
            <div className="w-14 h-14 rounded-2xl bg-gray-100 group-hover:bg-gray-200 flex items-center justify-center text-gray-600 group-hover:text-umass transition-colors">
              {link.icon}
            </div>
